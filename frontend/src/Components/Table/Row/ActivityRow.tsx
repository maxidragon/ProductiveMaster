...
const ActivityRow = ({ activity }: { activity: Activity }) => {
    ...
    const handleDelete = async () => {
        ...
        confirm({ description: "Are you sure you want to delete this activity?" }).then(async () => {
        ...
        <>
            {!hide && (
                ...
                >
                    ...
                    <TableCell>{formatDateTime(new Date(editedActivity.start_time))}</TableCell>
                    <TableCell>{formatDateTime(new Date(editedActivity.end_time))}</TableCell>
                    <TableCell>
            ...
            {edit && <EditActivityModal open={edit} handleClose={() => setEdit(false)} activity={editedActivity} updateActivity={editActivity} />}
        </>
    );
};
