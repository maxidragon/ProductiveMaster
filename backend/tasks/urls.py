...
urlpatterns = [
    ...
    path('project/users/list/<int:project_id>/', views.ListProjectUsers.as_view(), name='project-users'),
    path('project/users/add/', views.AddProjectUser.as_view(), name='add-project-user'),
    path('projects/users/update', views.UpdateDeleteProjectUser.as_view(), name='edit-project-user'),
